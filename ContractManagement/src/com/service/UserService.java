...
import com.dao.impl.RightDaoImpl;
...
<<<<<<< HEAD
	public boolean DeleteUser(int id) throws AppException {
		...
		try {
			...
			e.printStackTrace();
			throw new AppException("com.service.UserService.DeleteUser");
		}
		return flag;
	}
...
>>>>>>> origin/LiWenjie
	...
	public List<User> getUserListByRoleId(int roleId) throws AppException {
		...
		try {
			...
			e.printStackTrace();
			throw new AppException("com.service.UserService.getUserList");
		}	
		// Return userList
		return userList;
	}
	...
	public List<PermissionBusiModel> getYhqxList() throws AppException {
		...
		try {
			...
			e.printStackTrace();
			throw new AppException("com.service.UserService.getYhqxList");
		}	
	...
	public List<Role> getRoleList() throws AppException {	
		...
		try {
			...
			e.printStackTrace();
			throw new AppException("com.service.UserService.getRoleList");
		}
		return roleList;
	}
	...
	public boolean assignPermission(Right right) throws AppException {
		...
		try {
			...
			throw new AppException(
					"com.service.UserService.assignPermission");
		}
		return flag;
	}
...
<<<<<<< HEAD
	public boolean ModifyPassword(int id, String password) throws AppException {
		...
		try {
			if (userDao.isExist(id)) {// Execute save operation when the user does not exist
				flag = userDao.modify(id,password);// Return the operation result back to flag
			}
		} catch (AppException e) {
			e.printStackTrace();
	...
	public boolean IsExist(String name) throws AppException{
		boolean flag = false;//  Define flag 
		try {
				flag=userDao.isExistUser(name);
		} catch (AppException e) {
			e.printStackTrace();
			throw new AppException("com.service.UserService.IsExist");
		}
		return flag;
	}
	...
	public boolean IsSame(String name, String oPassword) throws AppException {
		boolean flag = false;//  Define flag 
		try {
				flag=userDao.isSame(name,oPassword);
		} catch (AppException e) {
			e.printStackTrace();
			throw new AppException("com.service.UserService.IsSame");
		}
		return flag;
	}
	...
	public boolean ChangePassword(String name, String nPassword) throws AppException {
		boolean flag = false;//  Define flag 
		try {
				flag=userDao.ChangePassword(name,nPassword);
		} catch (AppException e) {
			e.printStackTrace();
			throw new AppException("com.service.UserService.ChangePassword");
		}
		return flag;
	}
